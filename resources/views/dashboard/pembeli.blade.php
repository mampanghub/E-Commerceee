    ...
    @if (auth()->user()->role === 'pembeli')
        ...
        <style>
            ...
            @media (max-width: 768px) {
                ...
                /* Tampilkan mobile search */
                .mp-mobile-search {
                    display: block;
                }

                /* Hilangkan padding besar container di mobile */
                ...
                /* Section header stack kalau sempit */
                .section-header {
                    flex-wrap: wrap;
                    gap: 8px;
                }
        ...
        {{-- MOBILE SEARCH BAR — di luar container supaya full-width & nyambung navbar --}}
                ...
                <section class="hero-section">
                    <div class="hero-banner">
                        <div class="hero-content">
                            ...
                            <h1 class="hero-title">Halo, <span>{{ Auth::user()->name }}!</span></h1>
