        ...
        <div class="bg-white border-b border-blue-100">
            <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div class="flex items-center justify-between">
                    ...
                    <span
                        class="px-4 py-2 bg-blue-50 text-blue-600 rounded-xl text-xs font-black uppercase tracking-widest border border-blue-100">
            ...
            @else
                ...
                <div class="space-y-3">
                    @forelse($orders as $order)
                        ...
                        <div
                            class="bg-white rounded-2xl border border-slate-100 hover:border-blue-200 hover:shadow-sm transition-all duration-200">
                            <div class="flex items-center gap-4 p-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center gap-2 mb-1">
                                        ...
                                        <span
                                            class="px-2 py-0.5 rounded-lg text-[10px] font-black uppercase tracking-widest {{ $badgeClass }}">
                                            {{ $statusLabel }}
                                        </span>
                                    </div>
                                    ...
                                    <div class="flex flex-wrap gap-1">
                                        @foreach ($order->items as $it)
                                            <span
                                                ...
                                                {{ $it->jumlah }}×
                                                {{ Str::limit($it->product->nama_produk ?? 'Produk Dihapus', 20) }}
                                            </span>
                                        @endforeach
                                    </div>
