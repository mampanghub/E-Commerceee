                    ...
                    <form action="{{ route('products.update', $product->product_id) }}" method="POST"
                            ...
                            <div class="col-span-1">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="harga" value="{{ $product->harga }}"
                                        class="pl-10 w-full border border-gray-300 rounded-xl px-4 py-3" required>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <textarea name="deskripsi" rows="3"
                                class="w-full border border-gray-300 rounded-xl px-4 py-3">{{ $product->deskripsi }}</textarea>
                        </div>
                            ...
                            <div id="variant-list" class="space-y-3">
                                ...
                                <div class="variant-row grid grid-cols-12 gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100 items-center">
                                    ...
                                    <div class="col-span-4">
                                        ...
                                        <input type="text"
                                            name="variants[{{ $index }}][nama_varian]"
                        ...
                        <div class="border-t border-gray-100 pt-6">
                            ...
                            <div class="grid grid-cols-3 gap-4 mb-6">
                                ...
                                <div class="relative group aspect-square">
                                    ...
                                    @if ($img->is_primary)
                                        <span class="absolute top-2 left-2 bg-blue-600 text-white text-[10px] font-bold px-2 py-0.5 rounded-full">Utama</span>
                                    @endif
                                    @if ($img->variant)
                                        <span class="absolute bottom-2 left-2 bg-black/60 text-white text-[10px] px-2 py-0.5 rounded-full">{{ $img->variant->nama_varian }}</span>
                                    @endif
                            ...
                            <div class="flex justify-between items-center mb-3">
                                <label class="block text-sm font-semibold text-gray-700">Tambah Foto Baru & Tag Varian</label>
                            ...
                            <button type="button" onclick="addImageRow()"
                                class="mt-3 text-xs font-bold text-blue-600 hover:text-blue-800">+ Tambah Foto Lain</button>
                        </div>
