<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h1 class="text-2xl font-black text-slate-900 tracking-tight">Manajemen Produk</h1>
            </div>
    ...
    <div class="py-8 bg-slate-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div
                class="mb-6 bg-white rounded-2xl border border-slate-100 px-6 py-4 flex justify-between items-center shadow-sm">
                <p class="text-sm font-bold text-slate-600">
                    Total produk: <span class="text-blue-600 font-black">{{ $products->count() }}</span>
                </p>
                <span class="text-xs text-slate-400 font-bold">{{ now()->format('d M Y') }}</span>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        <thead class="bg-slate-50 border-b border-slate-100">
                            <tr>
                                <th
                                    class="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center w-10">
                                    No</th>
                                ...
                                <th class="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">
                                    Varian & Stok</th>
                                <th
                                    class="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest w-40">
                                    Kategori</th>
                                <th class="px-6 py-4 text-[10px] font-black text-slate-400 uppercase tracking-widest">
                                    Harga & Berat</th>
                                <th
                            ...
                            @forelse ($products as $item)
                                <tr class="hover:bg-indigo-50/30 transition duration-200">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-4">
                                            <div class="h-16 w-16 flex-shrink-0">
                                                ...
                                                @else
                                                    <div
                                                        class="h-16 w-16 rounded-xl bg-gray-100 flex items-center justify-center text-gray-400 border border-dashed border-gray-300">
                                            ...
                                            <div class="max-w-[200px]">
                                                ...
                                                <div class="text-[11px] text-gray-500 mt-1">ID:
                                                    #PROD-{{ $item->product_id }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 w-40">
                                        <span
                                            class="inline-block px-2.5 py-1 text-[10px] font-bold uppercase rounded-md bg-indigo-50 text-indigo-600 border border-indigo-100 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="text-[10px] text-gray-400 italic">{{ $item->berat ?? '-' }} gram
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="6" class="px-6 py-20 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 text-sm">Mulai tambah produk dengan variannya
                                                sekarang.</p>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div class="flex items-center justify-center min-h-screen p-4">
            <div class="bg-white w-full max-w-md rounded-2xl shadow-2xl p-6 transform transition-all">
                ...
                <form id="variantForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="block text-xs font-bold text-gray-400 uppercase mb-1 tracking-wider">Nama
                                Varian</label>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label
                                    class="block text-xs font-bold text-gray-400 uppercase mb-1 tracking-wider">Harga
                                    Varian</label>
                            ...
                            <div>
                                <label class="block text-xs font-bold text-gray-400 uppercase mb-1 tracking-wider">Stok
                                    Awal</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-400 uppercase mb-1 tracking-wider">Berat
                                (Gram)</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-400 uppercase mb-1 tracking-wider">Foto
                                Varian (Wajib)</label>
                    ...
                    <div class="mt-8 flex gap-3">
                        ...
                        <button type="submit"
                            class="flex-1 px-4 py-3 text-sm font-bold text-white bg-indigo-600 rounded-xl shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition">Simpan
                            Varian</button>
                    </div>
                </form>
            </div>
